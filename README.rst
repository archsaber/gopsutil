...
.. image:: https://circleci.com/gh/archsaber/gopsutil.svg?&style=shield
        :target: https://circleci.com/gh/archsaber/gopsutil

.. image:: https://coveralls.io/repos/archsaber/gopsutil/badge.svg?branch=master
        :target: https://coveralls.io/r/archsaber/gopsutil?branch=master

.. image:: https://godoc.org/github.com/archsaber/gopsutil?status.svg
        :target: http://godoc.org/github.com/archsaber/gopsutil
...
.. highlights:: Breaking Changes!
   ...
   Breaking changes is introduced at v2. See `issue 174 <https://github.com/archsaber/gopsutil/issues/174>`_ .


Migrating to v2
-------------------------

On gopsutil itself, `v2migration.sh <https://github.com/archsaber/gopsutil/blob/v2/v2migration.sh>`_ is used for migration. It can not be commonly used, but it may help you with migration.
...
.. code:: go
   ...
   import (
       ...
       "github.com/archsaber/gopsutil/mem"
   )
...
see http://godoc.org/github.com/archsaber/gopsutil
